...
<body style="background-color:powderblue;">
  <div class="main_container login_signup_container">
    ...
    <form action="" method="POST" novalidate>
      ...
      <input type="text" id="username" name="username" spellcheck="false" placeholder="Entrer votre nom complet" required>
      <label for="email">Email</label>
      <input type="email" id="email" name="email" spellcheck="false" placeholder="Entrer votre adress email" required>
