    ...
    .all_users .user_box{
        ...
        <div class="inner_profile">
            ...
            <div> 
                ...
                <input type="text" name="serch" style="width:500px; height:30px;"> <input type="submit" name="envoyer" value="rechercher
         " style="background-color:#0c82b9 ; color:white; height:40px; border:none;">
         </form>
            </div>
        </div>
        <nav>
            <ul>
                <li><a href="profile.php" rel="noopener noreferrer" class="active">domicile</a></li>
                ...
                <li><a href="recherche.php" rel="noopener noreferrer" >recheche</a></li>
